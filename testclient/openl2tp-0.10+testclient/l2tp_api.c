...
static SVCXPRT	*l2tp_rpc_xprt;
static SVCXPRT	*l2tp_event_rpc_xprt;

extern void l2tp_prog_1(struct svc_req *rqstp, register SVCXPRT *transp);
extern void l2tp_event_prog_1(struct svc_req *rqstp, register SVCXPRT *transp);
...
int l2tp_event_prog_1_freeresult (SVCXPRT *xprt, xdrproc_t proc, caddr_t addr)
{
	return TRUE;
}
