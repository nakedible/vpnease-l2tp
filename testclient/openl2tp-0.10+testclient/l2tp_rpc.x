...
const L2TP_APP_COPYRIGHT_INFO		= "(c) Copyright 2004,2005,2006";
const L2TP_APP_VENDOR_INFO		= "Katalix Systems Ltd.";
const L2TP_APP_MAJOR_VERSION		= 0;
const L2TP_APP_MINOR_VERSION		= 10;
...
const L2TP_API_SESSION_PROFILE_DEFAULT_SESSION_TX_CONNECT_SPEED		= 0;
...
const L2TP_API_PPP_PROFILE_FLAG_AUTH_FLAGS			= 128;
...
const L2TP_API_PPP_PROFILE_FLAG_COMP_FLAGS			= 512;
const L2TP_API_PPP_PROFILE_FLAG_MPPE     			= 1024;

/* PPP authentication options */
const L2TP_API_PPP_REQUIRE_NONE					= 1;
const L2TP_API_PPP_AUTH_REFUSE_EAP				= 2;
const L2TP_API_PPP_AUTH_REFUSE_MSCHAPV2				= 4;
const L2TP_API_PPP_AUTH_REFUSE_MSCHAP				= 8;
const L2TP_API_PPP_AUTH_REFUSE_CHAP				= 16;
const L2TP_API_PPP_AUTH_REFUSE_PAP				= 32;
const L2TP_API_PPP_REQUIRE_EAP                                  = 64;
const L2TP_API_PPP_REQUIRE_MSCHAPV2			        = 128;
const L2TP_API_PPP_REQUIRE_MSCHAP				= 256;
const L2TP_API_PPP_REQUIRE_CHAP				        = 512;
const L2TP_API_PPP_REQUIRE_PAP				        = 1024;

/* PPP compression options */
const L2TP_API_PPP_COMP_MPPC                                    = 1;
const L2TP_API_PPP_COMP_ACCOMP                                  = 2;
const L2TP_API_PPP_COMP_PCOMP                                   = 4;
const L2TP_API_PPP_COMP_BSDCOMP                                 = 8;
const L2TP_API_PPP_COMP_DEFLATE                                 = 16;
const L2TP_API_PPP_COMP_PREDICTOR1                              = 32;
const L2TP_API_PPP_COMP_VJ                                      = 64;
const L2TP_API_PPP_COMP_CCOMP_VJ                                = 128;
const L2TP_API_PPP_COMP_ASK_DEFLATE                             = 256;
const L2TP_API_PPP_COMP_ASK_BSDCOMP                             = 512;
...
const L2TP_API_PPP_PROFILE_DEFAULT_AUTH_FLAGS			= 0xffffffff;
...
const L2TP_API_PPP_PROFILE_DEFAULT_COMP_FLAGS			= 0;
const L2TP_API_PPP_PROFILE_DEFAULT_MPPE			        = 0;
...
program L2TP_PROG {
	version L2TP_VERSION {
		...
		int L2TP_TUNNEL_DELETE(uint16_t tunnel_id, optstring tunnel_name) = 10;
		...
		int L2TP_SESSION_DELETE(uint16_t tunnel_id, optstring tunnel_name, 
					uint16_t session_id, optstring session_name) = 20;
