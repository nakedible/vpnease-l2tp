...
int init_network (void)
{
    ...
    /* FIXME: this seems quite fragile to me, because the code
     * never checks return values (f.ex EAGAIN) of the system
     * calls made to this socket.
     * Must be fixed if this seems to cause problems under
     * high load and l2tpd is still in use. */
